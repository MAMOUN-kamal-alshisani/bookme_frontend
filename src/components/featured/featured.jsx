    ...
    return(
        ...
        <div className="featureContainer">
          {loading? (<h1>'loading please wait...'</h1>):(<><div className="featureList">
            ...
            {api?<> <h1>{Array.isArray(api.cities)?api?.cities[0]: api.cities[0]} city</h1>
            <h2>{Array.isArray(api.list)?api?.list[0]:api.list[0]} properties</h2></> :<h1> city</h1>}
            </div>
        </div>
        <div className="featureList">
           ...
           {api? <> <h1>{Array.isArray(api.cities)?api?.cities[1]:api.cities[1]} city</h1>
            <h2>{Array.isArray(api.list)?api?.list[1]:api.list[1]} properties</h2></> :<h1> city</h1>}
            </div>
        </div>
        <div className="featureList">
            ...
            <div className="featureTexts">
           {api? <> <h1>{Array.isArray(api.cities)?api?.cities[2]:api.cities[2]} city</h1>
            <h2>{Array.isArray(api.list)?api?.list[2]:api.list[2]} properties</h2></> :<h1> city</h1>}
            </div>
        </div>
        </> ) }
        </div>
